...
resource "aws_iam_policy" "sagemaker_policy" {
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      ############################################################
      # REQUIRED — Tagging permissions for pipeline jobs
      ############################################################
      {
        Effect = "Allow"
        Action = [
      ...
      ############################################################
      # REQUIRED — Allow SageMaker to pass this role to jobs
      ############################################################
      {
        Effect = "Allow"
        Action = [
...
###############################################
# CodeBuild Policy (unchanged from your last working version)
###############################################
